...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		MainWindow.setStyleSheet("color:rgb(255, 255, 255);background-color:rgb(0, 0, 0);")
		...
		self.e1.setStyleSheet("color:rgb(255, 0, 0);border:rgb(0, 0, 0);")
		self.e1.setText("")
		self.e1.setFrame(True)
		self.e1.setClearButtonEnabled(False)
		...
		self.e2.setStyleSheet("color:rgb(255, 0, 0);border:rgb(0, 0, 0);")
		...
		self.e3.setStyleSheet("color:rgb(255, 0, 0);border:rgb(0, 0, 0);")
		...
		self.e4.setStyleSheet("color:rgb(255, 0, 0);border:rgb(0, 0, 0);")
		...
		self.groupBox.setStyleSheet("border:rgb(0, 0, 0);")
		...
		self.rb1.setStyleSheet("color:rgb(255, 0, 255);")
		...
		self.rb2.setStyleSheet("color:rgb(255, 0, 255);")
		...
		self.rb3.setStyleSheet("color:rgb(255, 0, 255);")
		...
		self.rb4.setStyleSheet("color:rgb(255, 0, 255);")
		...
		self.list1.setStyleSheet("color: rgb(255, 255, 255);")
		...
		self.l1.setStyleSheet("color:rgb(255, 170, 0);")
		...
		self.list2.setStyleSheet("color: rgb(255, 255, 255);")
		...
		self.btn2.setStyleSheet("color:rgb(170, 0, 255);")
	...
	def retranslateUi(self, MainWindow):
		...
		self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#00ffff;\">Batsmen</span></p></body></html>"))
		self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#00ffff;\">Bowlers</span></p></body></html>"))
		self.label_7.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#00ffff;\">All Rounders</span></p></body></html>"))
		self.label_8.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#00ffff;\">Wicketkeepers</span></p></body></html>"))
		self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#ffff00;\">Player Speciality</span></p></body></html>"))
		...
		self.label_9.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#ffff00;\">Players List</span></p></body></html>"))
		self.btn1.setText(_translate("MainWindow", "Available Points : 1000"))
		self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#ffff00;\">Selected Players</span></p></body></html>"))
		self.l1.setText(_translate("MainWindow", "<html><head/><body><p><span style =\" color:#ffaa00;\">Team_Name</span></p></body></html>"))
	...
	def criteria(self,ctgr, item):
		...
		if msg!='' or self.avl<=59:
			msg = 'Error! Either you have exhausted your points or you are trying to exceed the specific player speciality limit.'
			self.showdlg(msg)
			return False
		if ctgr=="BAT":self.bat+=1
		if ctgr=="BWL":self.bwl+=1
...
if __name__ == "__main__":
	import sqlite3
	conn = sqlite3.connect('TeamInfo.db')    
	import sys
